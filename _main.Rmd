---
title: "Yet Another Statistics Book"
...
The <mark>standard deviation</mark> and the **variance** are measures of
...
| Parameters     | Statistics     |                |                |
+================+================+================+================+
| $$\sigma$$     | The standard   | $$s$$          | The standard   |
|                | deviation of a |                | deviation of a |
|                | population     |                | sample         |
|                |                |                |                |
|                | The lowercase  |                |                |
|                | Greek letter   |                |                |
|                | "sigma"        |                |                |
+----------------+----------------+----------------+----------------+
| $$\sigma^{2}$$ | The variance   | $$s^{2}$$      | The variance   |
|                | of a           |                | of a sample    |
|                | population     |                |                |
|                |                |                |                |
|                | "Sigma         |                |                |
...
populations and samples, like this:
  ...
  ----------------------------------------------- ---------------------------------------- ------------------------------------------ ------------------------------------------------------------------------
  $$\sigma_{1}$$                The standard deviation of population 1   $$s_{1}$$                The standard deviation of sample 1 (i.e. the sample from population 1)
  $$\sigma_{2}$$                The standard deviation of population 2   $$s_{2}$$                The standard deviation of sample 2 (i.e. the sample from population 2)
...
| bf{\chi}^{2}\mathbf{)}$ |                                  |
+==================================+==================================+
| $$\chi^{2}$$   | This is the Greek letter "chi"   |
|                                  | squared.                         |
|                                  |                                  |
...
|                                  |                                  |
+----------------------------------+----------------------------------+
| $$\chi_{\alpha,LT}^{2}$$         | A critical value of chi-square   |
|                                  | at $\alpha$ in the lower tail.   |
|                                  |                                  |
|                                  | The critical value in a          |
|                                  | **lower-tail** test with a       |
|                                  | $\chi^{2}$ **test statistic.**   |
+----------------------------------+----------------------------------+
| $$\chi_{\alpha,UT}^{2}$$         | A critical value of chi-square   |
|                                  | at $\alpha$ in the upper tail.   |
|                                  |                                  |
|                                  | The critical value in an         |
|                                  | **upper-tail** test with a       |
|                                  | $\chi^{2}$ **test statistic.**   |
+----------------------------------+----------------------------------+
| $$\chi_{\alpha/2,LT}^{2}$$       | A critical value of chi-square   |
|                                  | at $\alpha/2$ in the lower tail. |
|                                  |                                  |
...
|                                  | statistic.**                     |
+----------------------------------+----------------------------------+
| $$\chi_{\alpha/2,UT}^{2}$$       | A critical value of chi-square   |
|                                  | at $\alpha/2$ in the upper tail. |
|                                  |                                  |
...
|                                  |                                  |
+----------------------------------+----------------------------------+
| $$F_{\alpha}$$                   | An upper-tail critical value of  |
|                                  | $F$ at $\alpha$.                 |
|                                  |                                  |
|                                  | The critical value in an         |
...
+----------------------------------+----------------------------------+
| $$F_{\alpha/2}$$                 | A two-tailed critical value of   |
|                                  | $F$ at $\alpha/2$.               |
|                                  |                                  |
|                                  | The critical value in a          |
...
| **Lower Tail Test**  | **Upper Tail Test**  | **Two-Tailed Test**  |
+----------------------+----------------------+----------------------+
| $$H_{0}:\sigma^{2} \geq \sigma_{0}^{2}$$                               | $$                   | $$H_{0}:\ \sigma^{2  |
...
| $\mathbf{\si                     | $\mathbf{\si                     |
| gma}_{\mathbf{1}}^{2},$ | gma}_{\mathbf{1}}^{2},$ |
...
> sample variance as** $s_{1}^{2}$ **and the
> smaller sample variance as** $s_{2}^{2}$**.
...
<!--chapter:end:04_Chapter12.Rmd-->

# Chapter 13 {-}
<p class="h-large">Experimental Design and Analysis of Variance</p>![](./artwork/05.jpg)
...
<!--chapter:end:05_Chapter13.Rmd-->

# Chapter 14 {-}
<p class="h-large">Simple Linear Regression</p>![](./artwork/06.jpg)
...
<!--chapter:end:06_Chapter14.Rmd-->

# Chapter 15 {-}
<p class="h-large">Multiple Regression</p>![](./artwork/07.jpg)
